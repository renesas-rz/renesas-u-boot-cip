...
#if 0
#define SDHI_SD_PWR			(0x01E4 >> 1)
#define SDHI_EXT_SDIO			(0x01E8 >> 1)
#define SDHI_EXT_WP			(0x01EC >> 1)
#define SDHI_EXT_CD			(0x01F0 >> 1)
#define SDHI_EXT_CD_DAT3		(0x01F4 >> 1)
#define SDHI_EXT_CD_MASK		(0x01F8 >> 1)
#define SDHI_EXT_CD_DAT3_MASK		(0x01FC >> 1)
#endif
