...
/**
 * struct rzv2l_mod_clk - Module Clocks definitions
 *
...
/**
 * struct rzv2l_reset - Reset definitions
 *
 * @off: register offset
 * @bit: reset bit
...
/**
 * struct rzv2l_cpg_info - SoC-specific CPG Description
 *
 ...
 */
struct rzv2l_cpg_info {
	/* Core Clocks */
	const struct cpg_core_clk *core_clks;
	unsigned int num_core_clks;

	/* Module Clocks */
	const struct rzv2l_mod_clk *mod_clks;
	unsigned int num_mod_clks;
	unsigned int num_hw_mod_clks;

	/* Resets */
	const struct rzv2l_reset *resets;
	unsigned int num_resets;

	bool has_clk_mon_regs;
};

extern const struct rzv2l_cpg_info r9a07g054_cpg_info;
