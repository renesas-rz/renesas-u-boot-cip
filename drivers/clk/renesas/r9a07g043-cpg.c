 ...
 * RZ/G2UL CPG driver
 *
 * Copyright (C) 2021-2026 Renesas Electronics Corp.
 */
...
static const struct {
	struct rzg2ul_mod_clk common[63];
} mod_clks = {
	.common = {
		...
		DEF_MOD("cru_aclk",     R9A07G043_CRU_ACLK, R9A07G043_CLK_M0,
					0x564, 3),
		DEF_COUPLED("lcdc_a",	R9A07G043_LCDC_CLK_A, R9A07G043_CLK_M0,
					0x56c, 0),
		DEF_COUPLED("lcdc_p",	R9A07G043_LCDC_CLK_P, R9A07G043_CLK_ZT,
					0x56c, 0),
...
static const struct rzg2ul_reset r9a07g043_resets[] = {
...
const struct rzg2ul_cpg_info r9a07g043_cpg_info = {
	/* Core Clocks */
...
static const struct udevice_id r9a07g043_cpg_ids[] = {
	{
		.compatible	= "renesas,r9a07g043-cpg",
		.data		= (unsigned long)&r9a07g043_cpg_info,
	},
	{ /* sentinel */ }
};

U_BOOT_DRIVER(r9a07g043_cpg) = {
	.name		= "r9a07g043-cpg",
	.id		= UCLASS_NOP,
	.of_match	= r9a07g043_cpg_ids,
	.bind		= rzg2ul_cpg_bind,
