...
static const unsigned int r9a07g044l_crit_mod_clks[] __maybe_unused = {
...
/* Some struct value not defined: mstp_table, reset_node,get_pll_config */
 const struct cpg_mssr_info r9a07g044l_cpg_info = {
	.core_clk		= r9a07g044l_core_clks,
	.core_clk_size		= ARRAY_SIZE(r9a07g044l_core_clks),
	.mod_clk		= r9a07g044l_mod_clks,
	.mod_clk_size		= ARRAY_SIZE(r9a07g044l_mod_clks),
	.clk_extal_id		= CLK_XINCLK,
	.mod_clk_base		= CLK_MODE_BASE,
};

static const struct udevice_id r9a07g044l_clk_ids[] = {
	{
