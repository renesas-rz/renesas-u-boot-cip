...
/*
 * Renesas R8A774B1 CPG MSSR driver
 *
...
enum clk_ids {
	...
	LAST_DT_CORE_CLK = R8A774B1_CLK_OSC,
...
static const struct cpg_core_clk r8a774b1_core_clks[] = {
	...
	DEF_FIXED("s1d1",       R8A774B1_CLK_S1D1,  CLK_S1,         1, 1),
	...
	DEF_GEN3_RPC("rpc",     R8A774B1_CLK_RPC,   CLK_RPCSRC,    0x238),
...
static const struct mssr_mod_clk r8a774b1_mod_clks[] = {
	...
	DEF_MOD("sys-dmac2",		 217,	R8A774B1_CLK_S0D3),
	DEF_MOD("sys-dmac1",		 218,	R8A774B1_CLK_S0D3),
	...
	DEF_MOD("intc-ap",		 408,	R8A774B1_CLK_S3D1),
	DEF_MOD("audmac1",		 501,	R8A774B1_CLK_S0D3),
	DEF_MOD("audmac0",		 502,	R8A774B1_CLK_S0D3),
	DEF_MOD("drif7",		 508,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif6",		 509,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif5",		 510,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif4",		 511,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif3",		 512,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif2",		 513,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif1",		 514,	R8A774B1_CLK_S3D2),
	DEF_MOD("drif0",		 515,	R8A774B1_CLK_S3D2),
	...
	DEF_MOD("fcpvd2",		 601,	R8A774B1_CLK_S0D2),
	...
	DEF_MOD("fcpci0",		 617,	R8A774B1_CLK_S0D2),
	DEF_MOD("fcpcs",		 619,	R8A774B1_CLK_S0D2),
	DEF_MOD("vspd2",		 621,	R8A774B1_CLK_S0D2),
	...
	DEF_MOD("ehci1",		 702,	R8A774B1_CLK_S3D4),
	DEF_MOD("ehci0",		 703,	R8A774B1_CLK_S3D4),
	DEF_MOD("hsusb",		 704,	R8A774B1_CLK_S3D4),
	...
	DEF_MOD("imr1",			 822,	R8A774B1_CLK_S0D2),
	DEF_MOD("imr0",			 823,	R8A774B1_CLK_S0D2),
	...
	DEF_MOD("rpc",			 917,	R8A774B1_CLK_RPC),
...
static const struct mstp_stop_table r8a774b1_mstp_table[] = {
	{ 0x00200000, 0x0, 0, 0 },
	{ 0xFFFFFFFF, 0x0, 0, 0 },
	{ 0x340E2FDC, 0x2040, 0, 0 },
	{ 0xFFFFFFDF, 0x400, 0, 0 },
	{ 0x80000184, 0x180, 0, 0 },
	{ 0xC3FFFFFF, 0x0, 0, 0 },
	{ 0xFFFFFFFF, 0x0, 0, 0 },
	{ 0xFFFFFFFF, 0x0, 0, 0 },
	{ 0x01F1FFF7, 0x0, 0, 0 },
