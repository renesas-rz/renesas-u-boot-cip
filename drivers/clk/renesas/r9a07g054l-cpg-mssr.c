...
extern int rzv2l_clk_probe(struct udevice *dev);
extern int rzv2l_clk_remove(struct udevice *dev);
extern const struct clk_ops rzv2l_clk_ops;
...
static const struct cpg_core_clk r9a07g054l_core_clks[] = {
...
static const unsigned int r9a07g054l_crit_mod_clks[] __maybe_unused = {
...
/* Some struct value not defined: mstp_table, reset_node,get_pll_config */
 const struct cpg_mssr_info r9a07g054l_cpg_info = {
	...
	.core_clk_size		= ARRAY_SIZE(r9a07g054l_core_clks),
	.mod_clk		= r9a07g054l_mod_clks,
	.mod_clk_size		= ARRAY_SIZE(r9a07g054l_mod_clks),
	.clk_extal_id		= CLK_XINCLK,
	.mod_clk_base		= CLK_MODE_BASE,
};

static const struct udevice_id r9a07g054l_clk_ids[] = {
	{
		.compatible	= "renesas,r9a07g054l-cpg",
		.data		= (ulong)&r9a07g054l_cpg_info,
	},
	{ }
};

U_BOOT_DRIVER(clk_r9a07g054l) = {
	.name		= "clk_r9a07g054l",
	.id		= UCLASS_CLK,
	.of_match	= r9a07g054l_clk_ids,
	.priv_auto	= sizeof(struct rzv2l_clk_priv),
	.ops		= &rzv2l_clk_ops,
	.probe		= rzv2l_clk_probe,
	.remove		= rzv2l_clk_remove,
};
