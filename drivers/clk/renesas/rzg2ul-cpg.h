...
/*
 * RZ/G2UL Clock Pulse Generator
 *
 * Copyright (C) 2021-2023 Renesas Electronics Corp.
 *
 */

#ifndef __RENESAS_RZG2UL_CPG_H__
#define __RENESAS_RZG2UL_CPG_H__
...
/**
 * struct rzg2ul_mod_clk - Module Clocks definitions
 *
...
/**
 * struct rzg2ul_reset - Reset definitions
 *
 * @off: register offset
 * @bit: reset bit
...
/**
 * struct rzg2ul_cpg_info - SoC-specific CPG Description
 *
 ...
 */
struct rzg2ul_cpg_info {
	/* Core Clocks */
	const struct cpg_core_clk *core_clks;
	unsigned int num_core_clks;

	/* Module Clocks */
	const struct rzg2ul_mod_clk *mod_clks;
	unsigned int num_mod_clks;
	unsigned int num_hw_mod_clks;

	/* Resets */
	const struct rzg2ul_reset *resets;
	unsigned int num_resets;

	bool has_clk_mon_regs;
};

extern const struct rzg2ul_cpg_info r9a07g043_cpg_info;
