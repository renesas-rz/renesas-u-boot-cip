...
/*
 * Renesas R8A774C0 CPG MSSR driver
 *
...
static const struct cpg_core_clk r8a774c0_core_clks[] = {
	...
	DEF_GEN3_RPC("rpc",    R8A774C0_CLK_RPC,   CLK_RPCSRC,    0x238),
...
static const struct mssr_mod_clk r8a774c0_mod_clks[] = {
	...
	DEF_MOD("drif7",		 508,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif6",		 509,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif5",		 510,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif4",		 511,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif3",		 512,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif2",		 513,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif1",		 514,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif0",		 515,	R8A774C0_CLK_S3D2),
	...
	DEF_MOD("vin7",			 804,	R8A774C0_CLK_S1D2),
	DEF_MOD("vin6",			 805,	R8A774C0_CLK_S1D2),
	...
	DEF_MOD("rpc",			 917,	R8A774C0_CLK_RPC),
...
static const struct cpg_mssr_info r8a774c0_cpg_mssr_info = {
