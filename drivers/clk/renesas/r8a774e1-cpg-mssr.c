...
/*
 * Renesas R8A774E1 CPG MSSR driver
...
enum clk_ids {
	...
	LAST_DT_CORE_CLK = R8A774E1_CLK_S0D12,
...
static const struct cpg_core_clk r8a774e1_core_clks[] = {
	...
	DEF_FIXED("s1d1",       R8A774E1_CLK_S1D1,  CLK_S1,         1, 1),
	...
	DEF_GEN3_RPC("rpc",     R8A774E1_CLK_RPC,   CLK_RPCSRC,    0x238),
...
static const struct mssr_mod_clk r8a774e1_mod_clks[] = {
	DEF_MOD("fdp1-2",		 117,	R8A774E1_CLK_S2D1), /* ES1.x */
	...
	DEF_MOD("sys-dmac2",		 217,	R8A774E1_CLK_S0D3),
	DEF_MOD("sys-dmac1",		 218,	R8A774E1_CLK_S0D3),
	...
	DEF_MOD("usb-dmac30",		 326,	R8A774E1_CLK_S3D1),
	DEF_MOD("usb3-if1",		 327,	R8A774E1_CLK_S3D1), /* ES1.x */
	DEF_MOD("usb3-if0",		 328,	R8A774E1_CLK_S3D1),
	DEF_MOD("usb-dmac31",		 329,	R8A774E1_CLK_S3D1),
	...
	DEF_MOD("intc-ap",		 408,	R8A774E1_CLK_S3D1),
	DEF_MOD("audmac1",		 501,	R8A774E1_CLK_S0D3),
	DEF_MOD("audmac0",		 502,	R8A774E1_CLK_S0D3),
	DEF_MOD("drif7",		 508,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif6",		 509,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif5",		 510,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif4",		 511,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif3",		 512,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif2",		 513,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif1",		 514,	R8A774E1_CLK_S3D2),
	DEF_MOD("drif0",		 515,	R8A774E1_CLK_S3D2),
	...
	DEF_MOD("fcpvd3",		 600,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("fcpvd2",		 601,	R8A774E1_CLK_S0D2),
	...
	DEF_MOD("fcpvi2",		 609,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("fcpvi1",		 610,	R8A774E1_CLK_S0D1),
	DEF_MOD("fcpvi0",		 611,	R8A774E1_CLK_S0D1),
	DEF_MOD("fcpf2",		 613,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("fcpf1",		 614,	R8A774E1_CLK_S0D1),
	DEF_MOD("fcpf0",		 615,	R8A774E1_CLK_S0D1),
	DEF_MOD("fcpci1",		 616,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("fcpci0",		 617,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("fcpcs",		 619,	R8A774E1_CLK_S0D1),
	DEF_MOD("vspd3",		 620,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("vspd2",		 621,	R8A774E1_CLK_S0D2),
	...
	DEF_MOD("vspi2",		 629,	R8A774E1_CLK_S2D1), /* ES1.x */
	DEF_MOD("vspi1",		 630,	R8A774E1_CLK_S0D1),
	DEF_MOD("vspi0",		 631,	R8A774E1_CLK_S0D1),
	DEF_MOD("ehci3",		 700,	R8A774E1_CLK_S3D4),
	DEF_MOD("ehci2",		 701,	R8A774E1_CLK_S3D4),
	DEF_MOD("ehci1",		 702,	R8A774E1_CLK_S3D4),
	DEF_MOD("ehci0",		 703,	R8A774E1_CLK_S3D4),
	DEF_MOD("hsusb",		 704,	R8A774E1_CLK_S3D4),
	DEF_MOD("hsusb3",		 705,	R8A774E1_CLK_S3D4),
	DEF_MOD("csi21",		 713,	R8A774E1_CLK_CSI0), /* ES1.x */
	DEF_MOD("csi20",		 714,	R8A774E1_CLK_CSI0),
	DEF_MOD("csi41",		 715,	R8A774E1_CLK_CSI0),
	DEF_MOD("csi40",		 716,	R8A774E1_CLK_CSI0),
	DEF_MOD("du3",			 721,	R8A774E1_CLK_S2D1),
	DEF_MOD("du2",			 722,	R8A774E1_CLK_S2D1),
	DEF_MOD("du1",			 723,	R8A774E1_CLK_S2D1),
	DEF_MOD("du0",			 724,	R8A774E1_CLK_S2D1),
	DEF_MOD("lvds",			 727,	R8A774E1_CLK_S0D4),
	DEF_MOD("hdmi1",		 728,	R8A774E1_CLK_HDMI),
	...
	DEF_MOD("imr3",			 820,	R8A774E1_CLK_S0D2),
	DEF_MOD("imr2",			 821,	R8A774E1_CLK_S0D2),
	DEF_MOD("imr1",			 822,	R8A774E1_CLK_S0D2),
	DEF_MOD("imr0",			 823,	R8A774E1_CLK_S0D2),
	...
	DEF_MOD("rpc",			 917,	R8A774E1_CLK_RPC),
