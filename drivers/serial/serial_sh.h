...
#elif defined(CONFIG_RZG2L) || defined(CONFIG_R9A07G044L) || defined(CONFIG_R9A07G054L) || defined(CONFIG_R9A07G044C)
...
#endif
#elif defined(CONFIG_RZG2L) || defined(CONFIG_R9A07G044C) ||  defined(CONFIG_R9A07G044L) || defined(CONFIG_R9A07G054L)
SCIF_FNS(SCSMR,  0x00, 16)
