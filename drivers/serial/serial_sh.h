...
# define SCIF_ORER 0x0001  /* overrun error bit */
	...
	defined(CONFIG_R9A07G054L) || defined(CONFIG_R9A07G043U) || defined(CONFIG_R9A08G045S) || \
...
#define SCIF_FNS(name, sh3_scif_offset, sh3_scif_size,\
	...
	defined(CONFIG_R9A07G043U) || defined(CONFIG_R9A08G045S) || defined(CONFIG_RZF_DEV)
