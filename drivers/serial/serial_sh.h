...
# define SCIF_ORER 0x0001  /* overrun error bit */
      ...
      defined(CONFIG_R9A07G054L) || defined(CONFIG_RZF_DEV)
...
#elif defined(CONFIG_R9A07G044L) || defined(CONFIG_R9A07G044C) || defined(CONFIG_R9A07G054L) || defined(CONFIG_RZF_DEV)
