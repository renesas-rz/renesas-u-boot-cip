...
void s_init(void)
{
	...
	*(volatile u16 *)(PFC_PM25) = (*(volatile u16 *)(PFC_PM25) & 0xFFCF) | 0x20; /* Set P13_2(bit[5:4]) to Output mode */
	*(volatile u8 *)(PFC_P25) = (*(volatile u8 *)(PFC_P25) & 0xFB) | 0x4; /* Set P13_2(bit2) to High output */

#elif CONFIG_TARGET_SMARC_RZG3S
	/* SD power enable: SD0_PWR_EN - P2_1 = 1, SDIO_PWR_EN - P2_3 = 1, SDIO_PWR_SEL - P4_2 = 1, SD2_PWR_EN - P8_1 = 1 */
	*(volatile u8 *)(PFC_PMC31) &= 0xF1; /* Set P2_1(bit1), P2_2(bit2) and P2_3(bit3) to GPIO Mode */
	*(volatile u8 *)(PFC_PMC33) &= 0xFB; /* Set P4_2(bit2) to GPIO Mode */
	*(volatile u8 *)(PFC_PMC35) &= 0xFD; /* Set P8_1(bit1) to GPIO Mode */
	*(volatile u16 *)(PFC_PM31) = (*(volatile u16 *)(PFC_PM31) & 0xFF03) | 0x00A8; /* Set P2_1(bit[3:2]), P2_2(bit[5:4]) and P2_3(bit[7:6]) to Output mode */
	*(volatile u16 *)(PFC_PM33) = (*(volatile u16 *)(PFC_PM33) & 0xFFCF) | 0x0020; /* Set P4_2(bit[5:4]) to Output mode */
	*(volatile u16 *)(PFC_PM35) = (*(volatile u16 *)(PFC_PM35) & 0xFFF3) | 0x0008; /* Set P8_1(bit[3:2]) to Output mode */
	*(volatile u8 *)(PFC_P31) |= 0x0E; /* Set P2_1(bit1), P2_2(bit2) and P2_3(bit3) to High output */
