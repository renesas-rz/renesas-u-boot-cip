/*
 * board/renesas/skrzg1c/skrzg1c.c
 *     This file is skrzg1c board support.
 *
...
int board_init(void)
{
	...
	gd->bd->bi_boot_params = SKRZG1C_SDRAM_BASE + 0x100;
...
{
	gd->bd->bi_dram[0].start = SKRZG1C_SDRAM_BASE;
	gd->bd->bi_dram[0].size = SKRZG1C_SDRAM_SIZE;
}
