 ...
 *     This file is skrzg1e board support.
 *
...
void s_init(void)
{
	struct r8a7745_rwdt *rwdt = (struct r8a7745_rwdt *)RWDT_BASE;
	struct r8a7745_swdt *swdt = (struct r8a7745_swdt *)SWDT_BASE;
...
int board_init(void)
{
	...
	gd->bd->bi_boot_params = SKRZG1E_SDRAM_BASE + 0x100;
...
{
	gd->bd->bi_dram[0].start = SKRZG1E_SDRAM_BASE;
	gd->bd->bi_dram[0].size = SKRZG1E_SDRAM_SIZE;
}
