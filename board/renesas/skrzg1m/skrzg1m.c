 ...
 *     This file is skrzg1m board support.
 *
...
int board_init(void)
{
	...
	gd->bd->bi_boot_params = SKRZG1M_SDRAM_BASE + 0x100;
...
{
	gd->bd->bi_dram[0].start = SKRZG1M_SDRAM_BASE;
	gd->bd->bi_dram[0].size = SKRZG1M_SDRAM_SIZE;
}
