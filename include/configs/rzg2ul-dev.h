...
#ifndef __RZG2UL_DEV_H
#define __RZG2UL_DEV_H
...
#if CONFIG_TARGET_RZG2UL_TYPE1_DDR3L_DEV
#define CONFIG_SYS_SDRAM_SIZE		(0x20000000u - DRAM_RSV_SIZE) //total 512MB
#else
...
#if CONFIG_TARGET_RZG2UL_TYPE1_DDR3L_DEV
#define CONFIG_MAX_MEM_MAPPED		(0x20000000u - DRAM_RSV_SIZE)
#else
