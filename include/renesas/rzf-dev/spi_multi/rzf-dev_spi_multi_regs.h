...
#define CMNCR_MD_MANUAL						(1 << 31)
#define CMNCR_MD_EXT_READ					(0 << 31)
...
#define DRDRENR_DRDRE_DDR					(1 << 0)
#define DRDRENR_DRDRE_SDR					(0 << 0)
#define DRDRENR_OPDRE_DDR					(1 << 4)
#define DRDRENR_OPDRE_SDR					(0 << 4)
#define DRDRENR_ADDRE_DDR					(1 << 8)
#define DRDRENR_ADDRE_SDR					(0 << 8)
...
#define PHYCNT_WBUF_USED					(1 << 2)
#define PHYCNT_WBUF_NOT_USED				(0 << 2)
#define PHYCNT_WBUF2_USED					(1 << 4)
#define PHYCNT_WBUF2_NOT_USED				(0 << 4)
#define PHYCNT_CKSEL_SLOW					(0 << 16)
#define PHYCNT_CKSEL_FAST					(3 << 16)
#define PHYCNT_HS_MODE						(1 << 18)
#define PHYCNT_HS_OTHER_MODE				(0 << 18)
#define PHYCNT_OCT_MODE						(1 << 20)
#define PHYCNT_OCT_OTHER_MODE				(0 << 20)
#define PHYCNT_EXDS_USED					(1 << 21)
#define PHYCNT_EXDS_NOT_USED				(0 << 21)
#define PHYCNT_OCTA_HYPER_FLASH				(0 << 22)
#define PHYCNT_OCTA_ALTE					(1 << 22)
#define PHYCNT_OCTA_ORDER					(2 << 22)
#define PHYCNT_ALT_ALIGN_SUPPORTED			(1 << 30)
#define PHYCNT_ALT_ALIGN_NOT_SUPPORTED		(0 << 30)
#define PHYCNT_CAL_PERFOMED					(1 << 31)
#define PHYCNT_CAL_NOT_PERFOMED				(0 << 31)
...
#define PHYOFFSET2_DEF_DATA					(0x00000031)
