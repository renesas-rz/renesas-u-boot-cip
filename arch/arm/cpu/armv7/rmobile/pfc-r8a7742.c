/*
 * arch/arm/cpu/armv7/rmobile/pfc-r8a7742.c
 *     This file is r8a7742 processor support - PFC hardware block.
 *
...
static struct pinmux_info r8a7742_pinmux_info = {
	.name = "r8a7742_pfc",
...
{
	register_pinmux(&r8a7742_pinmux_info);
}
