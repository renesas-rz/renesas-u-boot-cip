...
enum {
	...
	GPIO_FN_SPEEDIN, GPIO_FN_VSP, GPIO_FN_CAN_CLK_C, GPIO_FN_TPUTO2_B,
	GPIO_FN_A17, GPIO_FN_MSIOF2_SYNC, GPIO_FN_SCIF4_RXD_E,
	GPIO_FN_CAN1_RX_B, GPIO_FN_AVB_AVTP_CAPTURE_B, GPIO_FN_A18,
	GPIO_FN_MSIOF2_SS1, GPIO_FN_SCIF4_TXD_E, GPIO_FN_CAN1_TX_B,
	GPIO_FN_AVB_AVTP_MATCH_B, GPIO_FN_A19, GPIO_FN_MSIOF2_SS2,
	GPIO_FN_PWM4, GPIO_FN_TPUTO2, GPIO_FN_MOUT0, GPIO_FN_A20, GPIO_FN_SPCLK,
	GPIO_FN_MOUT1,

	/* IPSR3 */
	GPIO_FN_A21, GPIO_FN_MOSI_IO0, GPIO_FN_MOUT2, GPIO_FN_A22,
	GPIO_FN_MISO_IO1, GPIO_FN_MOUT5, GPIO_FN_ATADIR1_N, GPIO_FN_A23,
	GPIO_FN_IO2, GPIO_FN_MOUT6, GPIO_FN_ATAWR1_N, GPIO_FN_A24, GPIO_FN_IO3,
	GPIO_FN_EX_WAIT2, GPIO_FN_A25, GPIO_FN_SSL, GPIO_FN_ATARD1_N,
	GPIO_FN_CS0_N, GPIO_FN_VI1_DATA8, GPIO_FN_CS1_N_A26, GPIO_FN_VI1_DATA9,
	GPIO_FN_EX_CS0_N, GPIO_FN_VI1_DATA10, GPIO_FN_EX_CS1_N,
	GPIO_FN_TPUTO3_B, GPIO_FN_SCIFB2_RXD, GPIO_FN_VI1_DATA11,
	GPIO_FN_EX_CS2_N, GPIO_FN_PWM0, GPIO_FN_SCIF4_RXD_C, GPIO_FN_TS_SDATA_B,
	GPIO_FN_RIF0_SYNC, GPIO_FN_TPUTO3, GPIO_FN_SCIFB2_TXD, GPIO_FN_SDATA_B,
	GPIO_FN_EX_CS3_N, GPIO_FN_SCIFA2_SCK, GPIO_FN_SCIF4_TXD_C,
	GPIO_FN_TS_SCK_B, GPIO_FN_RIF0_CLK, GPIO_FN_BPFCLK, GPIO_FN_SCIFB2_SCK,
	GPIO_FN_MDATA_B, GPIO_FN_EX_CS4_N, GPIO_FN_SCIFA2_RXD,
	GPIO_FN_I2C2_SCL_E, GPIO_FN_TS_SDEN_B, GPIO_FN_RIF0_D0, GPIO_FN_FMCLK,
	GPIO_FN_SCIFB2_CTS_N, GPIO_FN_SCKZ_B, GPIO_FN_EX_CS5_N,
	GPIO_FN_SCIFA2_TXD, GPIO_FN_I2C2_SDA_E, GPIO_FN_TS_SPSYNC_B,
	GPIO_FN_RIF0_D1, GPIO_FN_FMIN, GPIO_FN_SCIFB2_RTS_N, GPIO_FN_STM_N_B,
	GPIO_FN_BS_N, GPIO_FN_DRACK0, GPIO_FN_PWM1_C, GPIO_FN_TPUTO0_C,
	GPIO_FN_ATACS01_N, GPIO_FN_MTS_N_B, GPIO_FN_RD_N, GPIO_FN_ATACS11_N,
	GPIO_FN_RD_WR_N, GPIO_FN_ATAG1_N,

	/* IPSR4 */
	GPIO_FN_EX_WAIT0, GPIO_FN_CAN_CLK_B, GPIO_FN_SCIF_CLK, GPIO_FN_PWMFSW0,
	GPIO_FN_DU0_DR0, GPIO_FN_LCDOUT16, GPIO_FN_SCIF5_RXD_C,
	GPIO_FN_I2C2_SCL_D, GPIO_FN_CC50_STATE0, GPIO_FN_DU0_DR1,
	GPIO_FN_LCDOUT17, GPIO_FN_SCIF5_TXD_C, GPIO_FN_I2C2_SDA_D,
	GPIO_FN_CC50_STATE1, GPIO_FN_DU0_DR2, GPIO_FN_LCDOUT18,
	GPIO_FN_CC50_STATE2, GPIO_FN_DU0_DR3, GPIO_FN_LCDOUT19,
	GPIO_FN_CC50_STATE3, GPIO_FN_DU0_DR4, GPIO_FN_LCDOUT20,
	GPIO_FN_CC50_STATE4, GPIO_FN_DU0_DR5, GPIO_FN_LCDOUT21,
	GPIO_FN_CC50_STATE5, GPIO_FN_DU0_DR6, GPIO_FN_LCDOUT22,
	GPIO_FN_CC50_STATE6, GPIO_FN_DU0_DR7, GPIO_FN_LCDOUT23,
	GPIO_FN_CC50_STATE7, GPIO_FN_DU0_DG0, GPIO_FN_LCDOUT8,
	GPIO_FN_SCIFA0_RXD_C, GPIO_FN_I2C3_SCL_D, GPIO_FN_CC50_STATE8,
	GPIO_FN_DU0_DG1, GPIO_FN_LCDOUT9, GPIO_FN_SCIFA0_TXD_C,
	GPIO_FN_I2C3_SDA_D, GPIO_FN_CC50_STATE9, GPIO_FN_DU0_DG2,
	GPIO_FN_LCDOUT10, GPIO_FN_CC50_STATE10, GPIO_FN_DU0_DG3,
	GPIO_FN_LCDOUT11, GPIO_FN_CC50_STATE11, GPIO_FN_DU0_DG4,
	GPIO_FN_LCDOUT12, GPIO_FN_CC50_STATE12,

	/* IPSR5 */
	GPIO_FN_DU0_DG5, GPIO_FN_LCDOUT13, GPIO_FN_CC50_STATE13,
	GPIO_FN_DU0_DG6, GPIO_FN_LCDOUT14, GPIO_FN_CC50_STATE14,
	GPIO_FN_DU0_DG7, GPIO_FN_LCDOUT15, GPIO_FN_CC50_STATE15,
	GPIO_FN_DU0_DB0, GPIO_FN_LCDOUT0, GPIO_FN_SCIFA4_RXD_C,
	GPIO_FN_I2C4_SCL_D, GPIO_FN_CAN0_RX_C, GPIO_FN_CC50_STATE16,
	GPIO_FN_DU0_DB1, GPIO_FN_LCDOUT1, GPIO_FN_SCIFA4_TXD_C,
	GPIO_FN_I2C4_SDA_D, GPIO_FN_CAN0_TX_C, GPIO_FN_CC50_STATE17,
	GPIO_FN_DU0_DB2, GPIO_FN_LCDOUT2, GPIO_FN_CC50_STATE18,
	GPIO_FN_DU0_DB3, GPIO_FN_LCDOUT3, GPIO_FN_CC50_STATE19,
	GPIO_FN_DU0_DB4, GPIO_FN_LCDOUT4, GPIO_FN_CC50_STATE20,
	GPIO_FN_DU0_DB5, GPIO_FN_LCDOUT5, GPIO_FN_CC50_STATE21,
	GPIO_FN_DU0_DB6, GPIO_FN_LCDOUT6, GPIO_FN_CC50_STATE22,
	GPIO_FN_DU0_DB7, GPIO_FN_LCDOUT7, GPIO_FN_CC50_STATE23,
	GPIO_FN_DU0_DOTCLKIN, GPIO_FN_QSTVA_QVS, GPIO_FN_CC50_STATE24,
	GPIO_FN_DU0_DOTCLKOUT0, GPIO_FN_QCLK, GPIO_FN_CC50_STATE25,
	GPIO_FN_DU0_DOTCLKOUT1, GPIO_FN_QSTVB_QVE, GPIO_FN_CC50_STATE26,
	GPIO_FN_DU0_EXHSYNC_DU0_HSYNC, GPIO_FN_QSTH_QHS, GPIO_FN_CC50_STATE27,
	...
	GPIO_FN_VI1_DATA3, GPIO_FN_SCKZ, GPIO_FN_ATADIR0_N, GPIO_FN_ETH_LINK_B,
	GPIO_FN_SSI_SDATA2, GPIO_FN_HSCIF1_HRTS_N_B, GPIO_FN_SCIFA0_TXD_D,
	GPIO_FN_VI1_DATA4, GPIO_FN_STM_N, GPIO_FN_ATARD0_N,
	GPIO_FN_ETH_REFCLK_B, GPIO_FN_SSI_SCK9, GPIO_FN_SCIF2_SCK_B,
	GPIO_FN_PWM2_B, GPIO_FN_VI1_DATA5, GPIO_FN_MTS_N, GPIO_FN_ATACS00_N,
	GPIO_FN_ETH_TXD1_B, GPIO_FN_SSI_WS9, GPIO_FN_SCIF2_RXD_B,
	GPIO_FN_I2C3_SCL_E, GPIO_FN_VI1_DATA6, GPIO_FN_ATACS10_N,
	GPIO_FN_ETH_TX_EN_B, GPIO_FN_SSI_SDATA9, GPIO_FN_SCIF2_TXD_B,
	GPIO_FN_I2C3_SDA_E, GPIO_FN_VI1_DATA7, GPIO_FN_EX_WAIT1,
